...
<div class="adminArticle">
    <div class="articleLine">
        ...
        <!-- tri view -->
        <div class="title">
            <a href="index.php?action=showMonitoringPage&sort=views&order=asc">Nb vue
                <i class="fa-solid fa-caret-up
        ...
        <!-- tri commentaire -->
        <div class="title">
            <a href="index.php?action=showMonitoringPage&sort=nbOfComments&order=asc">Nb commentaire
                <i class="fa-solid fa-caret-up
